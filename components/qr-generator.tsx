  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 min-h-0">
      ...
      <div className="w-full lg:w-[360px] lg:flex-shrink-0 space-y-4 overflow-y-auto max-h-[calc(100vh-120px)]">
        <section className="bg-white rounded-xl border border-purple-100 p-5 shadow-sm">
          <h2 className="text-sm font-bold text-purple-800 mb-3 flex items-center gap-2">内容</h2>
          <ContentInput onContent={handleContent} />
        </section>

        <section className="bg-white rounded-xl border border-purple-100 p-5 shadow-sm">
          <h2 className="text-sm font-bold text-purple-800 mb-3 flex items-center gap-2">样式</h2>
          {error && (
